const Contact = () => (
  <section className="contact-section" id="contact" style={{ background: 'linear-gradient(120deg, #e3eafc 60%, #f7fafc 100%)', padding: '4.5rem 0' }}>
    <div className="contact-card" style={{ maxWidth: 540, margin: '0 auto', background: '#fff', borderRadius: 22, boxShadow: '0 8px 32px 0 rgba(60,72,88,0.13)', padding: '2.5rem 2rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <h2 style={{ color: '#1746a2', fontWeight: 900, fontSize: '2.1rem', marginBottom: 8, textAlign: 'center' }}>Contact Us</h2>
      <div style={{ color: '#2563eb', fontWeight: 600, fontSize: '1.13rem', marginBottom: 18, textAlign: 'center' }}>
        Have questions? Our team is here to help you 7 days a week.
      </div>
      ...
      <form className="contact-form" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 16 }}>
        <input type="text" placeholder="Full Name" style={{ border: '1.5px solid #cfd8dc', borderRadius: 10, padding: '0.9rem 1.2rem', fontSize: '1.08rem', marginBottom: 10 }} />
        <input type="email" placeholder="Email" style={{ border: '1.5px solid #cfd8dc', borderRadius: 10, padding: '0.9rem 1.2rem', fontSize: '1.08rem', marginBottom: 10 }} />
        <input type="tel" placeholder="Phone" style={{ border: '1.5px solid #cfd8dc', borderRadius: 10, padding: '0.9rem 1.2rem', fontSize: '1.08rem', marginBottom: 10 }} />
        <textarea placeholder="Describe Your Case" style={{ border: '1.5px solid #cfd8dc', borderRadius: 10, padding: '0.9rem 1.2rem', fontSize: '1.08rem', minHeight: 90, marginBottom: 10, resize: 'vertical' }} />
